...
**Attachment: 1787334260611_image.png · image**

![1787334260611_image.png](https://claude.ai/api/b78a8af5-e223-4b19-b102-c31154cc100a/files/3127a5a5-6ec3-4ce5-90f9-7a728a9b0ae0/preview)
...
> 💬 Mentores
> Raquel DevRel | Telegrama: @rraigal y Twitter: @rraigal_
...
> 
> Dos cosas que suelen causar problemas: la plantilla envía un upgradeenlace de marcador de posición y falla INVALID_URLhasta que lo reemplazas con uno real de pear touch. Y en la daemonvariante, ese error va a <storage>/updates.logen lugar de a tu terminal, revisa allí primero cuando las actualizaciones parezcan estar muertas.
> 
> Reutilización de código
> Puedes reutilizar el código existente. Solo evaluaremos lo que hayas creado durante el hackathon.
...
> 💬 Mentores
> Raquel, DevRel | Telegrama: @rraigal | Gorjeo: @rraigal_
> La mentoría se realiza tanto en persona como en línea: tendrás tu tema específico en el chat grupal de Telegram del hackathon y los hackers podrán contactar a los mentores siempre que los necesiten.
...
> 4:154 minutos y 15 segundosHoly [ __ ] Peanut butter, bro. That mean I just broke my nail coating.
...
> 5:275 minutos y 27 segundosYo, this [ __ ] bro.
...
> 6:576 minutos y 57 segundosYeah. Holy [ __ ] Oh, that's a nice camera app.
...
> 7:427 minutos y 42 segundosShrink that [ __ ] Hi. Bang.
...
> 8:408 minutos y 40 segundosIt looks The UI is actually like the most beautiful [ __ ] ever. Um, so yeah, I'm going to demo right now. We have a plan.
...
> 9:009 minutosThe video link. I'm trolling. I'm trolling. Just wait. I just don't want to miss a submission. You won't. Oh [ __ ] I don't think I have time, bro. Not going to lie.
...
> 9:189 minutos y 18 segundosI thought you were going to like stick it like side by side or some [ __ ] Yeah. Oh, yeah. That makes more sense.
> 9:259 minutos y 25 segundosAnyways, guys, we finished our submission. That [ __ ] was hella stressful though.
...
> 9:409 minutos y 40 segundosI don't know. It's actually a [ __ ] There's no way. Can you unite Vivian for me? Ignite her. Huh? Tap her on the head with the sword. Ignite her. You got to knit her.
...
> 10:1110 minutos y 11 segundosWell, we got Bill with Zed, bro. We got to lock the [ __ ] in.
...
> 2:062 minutos y 6 segundostheit we're about to head back to our respective homes that's right sleep in our own beds yep yeah type [ __ ] and then
...
> 7:137 minutos y 13 segundos[ __ ] back to the time lapse
...
> 8:248 minutos y 24 segundoschin Robert Ian says Hi um tell Ian she has chop chin what the [ __ ] n tell her I say
...
> 13:3913 minutos y 39 segundosvirtual environment stuff n requirements oh [ __ ] I don't [ __ ]
...
> 14:3814 minutos y 38 segundosall right luckily the robot actually moved let's go the [ __ ] curs is messing up okay we're going to go ahead and finish the
...
> 14:5514 minutos y 55 segundosup with my team judging hacking ends in about 30 minutes we have 2 minutes left what the [ __ ] it just wait it say 17 more minutes oh yeah they they already
> 15:0415 minutos y 4 segundosextended that [ __ ] so I got to do that all oh wait okay deleted all the sponsors so let's go again let's go
...
> 17:0517 minutos y 5 segundosthey look at the robot and they're like damn what the [ __ ] is that yeah like that walk into the closing ceremony right now then overall the school is rated
...
> 18:2518 minutos y 25 segundoswinner defeated at that [ __ ] all right rap of tree hacks I'm very happy to have won something I think we get DJ
...
Tengo este video que no tiene transcripción: https://www.youtube.com/watch?v=6h_7gzUso1I
...
You also have access to sponsor’s mentors directly in the hackathon’s [Telegram group chat](https://t.me/+r3bV_2KPZA0wYjM5). Each sponsor has a dedicated topic where their mentors are tagged and pinned.
...
**Dos cosas que rompen a todos, avisadas por ellos mismos:** la plantilla trae un link de upgrade placeholder y falla con `INVALID_URL` hasta que lo reemplacés con uno real de `pear touch`. Y en la variante `daemon` ese error va a `<storage>/updates.log` en vez de a la terminal.
...
Telegram `@rraigal` · Twitter `@rraigal_` · IRL + Online · Backend, Smart Contracts, DeFi, AI/ML.
...
>
> Primeros 30 segundos: factura AR$1.240.000; extracto AR$1.180.000; pantalla: MISMATCH — AR$60.000.
>
...
Le puse una escalera de repliegue de cinco escalones donde **cada escalón sigue siendo una entrega válida a un bounty distinto**: gate de Pear ($1.000), más división manual ($1.500), más QVAC ($2.500), más WDK ($3.500). Construís en ese orden y anotás solo los escalones que cerraste. Nunca te anotás a un bounty que no cumpliste, porque eso es justo lo que descartan sin revisar.
...
**La primera vez baja el modelo**, así que va a tardar. `LLAMA_3_2_1B_INST_Q4_0`
...
|---|---|---|
| No imprime ningún log | Falta el archivo de config o la variable | `set QVAC_CONFIG_PATH=./qvac.config.json` |
...
--------------------------
VK_LAYER_AMD_switchable_graphics AMD switchable graphics layer  1.3.302  version 1
...
salida: la capa `VK_LAYER_VALVE_steam_fossilize` reporta `1.4.303`. O sea que
...
Tenés que ver `package.json`, `node_modules` y `qvac.config.json`.
...
La primera vez baja el modelo. `LLAMA_3_2_1B_INST_Q4_0` es de mil millones de
...
va a tirar `INVALID_URL`. Es el error donde se traba todo el mundo.
...
- [ ] `npm start` arranca sin `INVALID_URL`
...
| QVAC no imprime nada | Falta el config o la variable | Crear `qvac.config.json` + `set QVAC_CONFIG_PATH=./qvac.config.json` |
| `Cannot use import outside a module` | Falta el tipo módulo | `npm pkg set type=module` |
...
| `INVALID_URL` al arrancar Pear | Link de upgrade placeholder | `pear touch` y pegar el resultado en `package.json` |
...
> 21/08/2026  11:17 p. m.    <DIR>          node_modules
...
> Layers: count = 4
> =================
> VK_LAYER_AMD_switchable_graphics (AMD switchable graphics layer) Vulkan version 1.3.302, layer version 1:
>         Layer Extensions: count = 0
>         Devices: count = 1
>                 GPU id = 0 (AMD Radeon(TM) 880M Graphics)
>                 Layer-Device Extensions: count = 0
> 
> VK_LAYER_OBS_HOOK (Open Broadcaster Software hook) Vulkan version 1.3.216, layer version 1:
>         Layer Extensions: count = 0
>         Devices: count = 1
>                 GPU id = 0 (AMD Radeon(TM) 880M Graphics)
>                 Layer-Device Extensions: count = 0
> 
> VK_LAYER_VALVE_steam_fossilize (Steam Pipeline Caching Layer) Vulkan version 1.4.303, layer version 1:
>         Layer Extensions: count = 0
>         Devices: count = 1
>                 GPU id = 0 (AMD Radeon(TM) 880M Graphics)
>                 Layer-Device Extensions: count = 0
...
> =====================
> GPU id : 0 (AMD Radeon(TM) 880M Graphics) [VK_KHR_win32_surface]:
...
> npm error 404 Note that you can also install from a
> npm error 404 tarball, folder, http url, or git url.
> npm error A complete log of this run can be found in: C:\Users\Emi\AppData\Local\npm-cache\_logs\2026-08-22T02_50_44_825Z-debug-0.log
> 
> C:\hack\qvac-pruebas>
...
Sin eso, la app no arranca: tira `INVALID_URL`. Es el error donde se traba todo el
...
| QVAC no imprime nada | Falta la variable | `set QVAC_CONFIG_PATH=./qvac.config.json` |
| `Cannot use import outside a module` | Falta el tipo módulo | `npm pkg set type=module` |
...
| `INVALID_URL` al arrancar Pear | Link placeholder | `pear touch` y pegar en `package.json` |
...
> 
> C:\hack\qvac-pruebas>set QVAC_CONFIG_PATH=./qvac.config.json
> 
> C:\hack\qvac-pruebas>node prueba.js
> ✖ Error: spawn UNKNOWN
>     at ChildProcess.spawn (node:internal/child_process:420:11)
>     at Object.spawn (node:child_process:787:9)
>     at spawn (C:\hack\qvac-pruebas\node_modules\bare-runtime\lib\spawn.js:31:28)
>     at Server.<anonymous> (file:///C:/hack/qvac-pruebas/node_modules/@qvac/sdk/dist/client/rpc/node-rpc-client.js:342:34)
...
> [sdk:server] Loading from registry: unsloth/Llama-3.2-1B-Instruct-GGUF/blob/b69aef112e9f895e6f98d7ae0949f72ff09aa401/Llama-3.2-1B-Instruct-Q4_0.gguf
> [sdk:server] ­ƒöù Creating new registry client...
> [sdk:server] Ô£à Registry client ready
> [sdk:server] ­ƒôÑ Downloading blob directly: Llama-3.2-1B-Instruct-Q4_0.gguf
...
> [sdk:server] Ô£à Downloaded to C:\Users\Emi\.qvac\models\f2bade0bc5cd4a8c_Llama-3.2-1B-Instruct-Q4_0.gguf
> [sdk:server] Ô£à Checksum validated for Llama-3.2-1B-Instruct-Q4_0.gguf
> [sdk:server] Loaded Model to C:\Users\Emi\.qvac\models\f2bade0bc5cd4a8c_Llama-3.2-1B-Instruct-Q4_0.gguf
> Bajando 100% (773.0/773.0 MB)
...
>   path: 'C:\\Users\\Emi\\.qvac\\models\\f2bade0bc5cd4a8c_Llama-3.2-1B-Instruct-Q4_0.gguf',
>   projectionPath: '',
>   config: {
>     ctx_size: '1024',
>     gpu_layers: '99',
...
> ✖ WORKER_CRASHED: Bare worker exited mid-request (code=3221225477, signal=null) — in-flight calls were aborted
>     at handlePostHandshakeExit (file:///C:/hack/qvac-pruebas/node_modules/@qvac/sdk/dist/client/rpc/node-rpc-client.js:268:28)
>     at ChildProcess.<anonymous> (file:///C:/hack/qvac-pruebas/node_modules/@qvac/sdk/dist/client/rpc/node-rpc-client.js:382:25)
...
>   ├── /v1/responses (POST)
>   │   └── /:id (GET, HEAD, DELETE)
>   │       └── /input_items (GET, HEAD)
>   ├── /v1/vector_stores (GET, HEAD, POST)
...
>     at Timeout._onTimeout (file:///C:/hack/qvac-pruebas/node_modules/@qvac/sdk/dist/client/rpc/node-rpc-client.js:317:20)
...
> Error: Invalid recipient address for 'ethereum' (INVALID_FORMAT).
...
```
config: { ctx_size: '1024', gpu_layers: '99', device: 'gpu', ... }
[llamacpp-completion] Activating addon
🪦 Bare worker exited post-handshake (code=3221225477)
```

El código `3221225477` es `0xC0000005` en hexadecimal: **violación de acceso a memoria** en Windows. Un segfault. Y ocurre exactamente al activar el addon con `device: 'gpu'` y `gpu_layers: '99'` — o sea, mandando las 99 capas del modelo a tu Radeon 880M por Vulkan.
...
Que `device: "cpu"` es un campo válido de configuración para modelos `llm` está confirmado en la documentación de configuración, donde aparece textualmente como `"llm": { "device": "cpu", "ctx_size": 1024 }`. Lo que **no** verifiqué es que `modelConfig` en `loadModel()` acepte exactamente esa forma — confirmalo en `https://docs.qvac.tether.io/reference/api/#loadmodel` antes de pelearte si falla.

**Y desinstalá `bare-runtime`.** Fijate que después de instalarlo el error cambió de crash a `RPC_INIT_TIMEOUT`: eso huele a choque de versiones con el Bare que el SDK ya trae. El propio `doctor` lo lista como opcional, solo para quien apunta a Bare directamente. No es tu caso.
...
**Ese `defaultRotationAngles: [90, 180, 270]` es para tickets torcidos.** Y `magRatio` y `contrastRetry` son las perillas para fotos con poca luz. Si tu ticket sale mal, esos tres parámetros son lo primero que hay que tocar. `langList: ['en']` probablemente lo quieras en `['es']` o `['en','es']` — el modelo es `OCR_LATIN`, alfabeto latino.
...
> configuración lo muestra como `"llm": { "device": "cpu", "ctx_size": 1024 }`.
...
Si lo instalaste global y el error cambió de crash a `RPC_INIT_TIMEOUT`, es choque
...
Sin eso la app no arranca: tira `INVALID_URL`. Es donde se traba todo el mundo.
...
**Simular sin mandar — hacelo siempre primero.** Reemplazá `0xTU_DIRECCION` por
una dirección real; con el texto `DIRECCION` da `INVALID_FORMAT`:

```cmd
wdk send --network ethereum --to 0xTU_DIRECCION --amount 0.0001 --wallet hackathon --dry-run
```
...
```bash
QVAC_CONFIG_PATH=./qvac.config.json node prueba.js
```
...
|---|---|---|
| `langList` | Idioma del texto | Cambiá a `['es']` o `['en','es']`. El modelo `OCR_LATIN` es alfabeto latino |
...
- [ ] `hello-pear-bare` clonado e instalado
- [ ] `pear touch` corrido y link pegado en `package.json`
- [ ] `npm start` imprime `CLI ready` sin `INVALID_URL`
...
| **`WORKER_CRASHED code=3221225477`** | **GPU integrada + Vulkan** | **`modelConfig: { device: 'cpu' }`** |
| `RPC_INIT_TIMEOUT` después de instalar bare-runtime | Choque de versiones | `npm uninstall -g bare-runtime` |
| QVAC no imprime nada | Falta la variable de config | `set QVAC_CONFIG_PATH=...` (Win) o inline (Mac) |
| `Cannot use import outside a module` | Falta el tipo módulo | `npm pkg set type=module` |
...
| `wdk send` → `INVALID_FORMAT` | Dirección de ejemplo, no real | Poné una dirección `0x...` verdadera |
...
`wdk send` con el texto literal `DIRECCION` da `INVALID_FORMAT`. Es esperable: hay que poner una dirección `0x...` real. Podés usar la tuya misma como destino para probar el `--dry-run`.
...
Confirmé lo que necesitaba. La firma de `loadModel()` en la referencia de API muestra `modelConfig` como el lugar correcto: `loadModel({ modelSrc: LLAMA_3_2_1B_INST_Q4_0, modelConfig: { ctx_size: 2048 } })`. Y la página de configuración muestra `device: "cpu"` exactamente como campo del bloque `llm` dentro de esa misma estructura. Es el lugar correcto.
...
[sdk:server] Loading from registry: qvac_models_compiled/ocr/gguf/easyocr/2026-05-14/latin_g2.gguf
[sdk:server] Loading from registry: qvac_models_compiled/ocr/gguf/easyocr/2026-05-14/craft_mlt_25k.gguf
[sdk:server] ­ƒöù Creating new registry client...
[sdk:server] Ô£à Registry client ready
[sdk:server] ­ƒôÑ Downloading blob directly: latin_g2.gguf
[QVACRegistryClient] [INFO] Downloading blob directly {
...
[sdk:server] ­ƒôÑ Downloading blob directly: craft_mlt_25k.gguf
[QVACRegistryClient] [INFO] Downloading blob directly {
  coreKey: 'd90c02630333...',
  blockOffset: 2108162,
  blockLength: 1269,
...
[QVACRegistryClient] [INFO] Blob download complete (direct)
[sdk:server] Ô£à Downloaded to C:\Users\Emi\.qvac\models\1bd09b23f28caa7e_latin_g2.gguf
[sdk:server] Ô£à Checksum validated for latin_g2.gguf
[sdk:server] Loaded Model to C:\Users\Emi\.qvac\models\1bd09b23f28caa7e_latin_g2.gguf
[QVACRegistryClient] [INFO] Cleared blob blocks from corestore { start: 2108162, end: 2109431, blocks: 0 }
[QVACRegistryClient] [INFO] Blob download complete (direct)
[sdk:server] Ô£à Downloaded to C:\Users\Emi\.qvac\models\bb5d57baeb6ae9e7_craft_mlt_25k.gguf
[sdk:server] Ô£à Checksum validated for craft_mlt_25k.gguf
[sdk:server] Loaded Model to C:\Users\Emi\.qvac\models\bb5d57baeb6ae9e7_craft_mlt_25k.gguf
...
✖ MODEL_LOAD_FAILED: Failed to load model: Unsupported language(s): none of the requested languages are supported: es
    at runLoadModel (file:///C:/hack/qvac-pruebas/node_modules/@qvac/sdk/dist/client/api/load-model.js:118:15)
...
Encontré el problema y es mío. **La documentación usa `langList: ['en']`** y yo lo cambié a `['es']` pensando que era mejor para tickets argentinos. El modelo `latin_g2` lo rechazó.
...
**Y no te preocupes de que diga "en" para tickets en español.** El modelo se llama `OCR_LATIN` y el archivo que bajó es `latin_g2`: es un reconocedor de **alfabeto latino**, no un traductor. Lee las formas de las letras, no entiende idiomas. "MILANESA" y "COCA COLA" las va a leer igual de bien. Lo único que puede fallar son los acentos y la ñ, y en un ticket lo que más importa son los **números**, que son idénticos en los dos idiomas.
